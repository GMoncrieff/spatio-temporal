...
python scripts/predict_region_diffusion.py \
  --checkpoint <v26-ckpt> \
  --predict_region config/region_to_predict_small.geojson \
  --output_dir data/predictions_diffusion/v36i \
  --ensemble_n 16 --predict_batch_size 2 --num_inference_steps 30 \
  --m_sample_diverse --m_sample_min 0.2 --m_sample_max 0.8 \
  --residual_scale_pos 5.0 --residual_scale_neg 0.30 \
  --residual_mask_threshold 0.07 --residual_mask_softness 0.01 \
  --residual_mask_mode gate \
  --cond_perturb_std 0.05 --cond_perturb_lowfreq_size 6
```
...
python scripts/predict_region_diffusion.py \
  --checkpoint <v26-ckpt> \
  --predict_region config/region_to_predict_small.geojson \
  --output_dir data/predictions_diffusion/v36f \
  --ensemble_n 16 --predict_batch_size 2 --num_inference_steps 30 \
  --m_sample_diverse --m_sample_min 0.05 --m_sample_max 1.2 \
  --residual_scale_pos 4.0 --residual_scale_neg 0.35 \
