...
| Tile-mean MAE (mean) | 0.0064 |
| Tile-mean MAE (95th %ile) | 0.0277 |
| Histogram intersection (median) | **0.859** |
| Histogram intersection (mean) | 0.790 |
| Pearson r (predicted vs. observed tile-mean Δhm) | 0.706 |
| Coverage rate (q025 ≤ obs ≤ q975), all bins | 0.540 (target ≈ 0.95) |
...
![Q-Q max-of-field](../outputs/diffusion_v36hh_post_t030/qq_max_of_field.png)
![Q-Q mean-of-field](../outputs/diffusion_v36hh_post_t030/qq_mean_of_field.png)

## Figures

- Map comparison: ![](../outputs/diffusion_v36hh_post_t030/map_comparison.png)
- Tile-level summaries: ![](../outputs/diffusion_v36hh_post_t030/tile_metrics.png)
