...
| Tile-mean MAE (95th %ile) | 0.0383 |
| Histogram intersection (median) | **0.522** |
| Histogram intersection (mean) | 0.501 |
| Pearson r (predicted vs. observed tile-mean Δhm) | 0.699 |
| Coverage rate (q025 ≤ obs ≤ q975), all bins | 0.712 (target ≈ 0.95) |
...
|---|---:|---:|
| `[ -1.000, -0.005]` | 59,954 | 0.426 |
| `[ -0.005, +0.005]` | 789,483 | 0.779 |
| `[ +0.005, +0.020]` | 123,519 | 0.552 |
| `[ +0.020, +0.100]` | 103,808 | 0.583 |
| `[ +0.100, +0.200]` | 10,953 | 0.524 |
| `[ +0.200, +0.400]` | 1,746 | 0.196 |
...
- Predicted tail mass: 1642.1660
- **Ratio (pred / obs):** **1.237** (<<1 = under-predicting tail; ~1 = calibrated; >1 = over)

### Tail exceedance (deterministic + q975 ensemble support)

| Threshold | n(obs>t) | n(pred>t) | POD | CSI | FAR | q975 soft-POD |
|---|---|---|---|---|---|---|
| +0.050 |     45,659 |     97,849 | 0.470 | 0.176 | 0.781 | 0.917 |
| +0.100 |     12,833 |     17,714 | 0.196 | 0.090 | 0.858 | 0.742 |
| +0.200 |      1,880 |        623 | 0.096 | 0.077 | 0.711 | 0.359 |
| +0.400 |        134 |         19 | 0.090 | 0.085 | 0.368 | 0.142 |

![Q-Q max-of-field](../outputs/diffusion_v36h/qq_max_of_field.png)

## Figures

- Map comparison: ![](../outputs/diffusion_v36h/map_comparison.png)
- Tile-level summaries: ![](../outputs/diffusion_v36h/tile_metrics.png)
