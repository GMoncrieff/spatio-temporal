...
| Tile-mean MAE (95th %ile) | 0.0359 |
| Histogram intersection (median) | **0.551** |
| Histogram intersection (mean) | 0.529 |
| Pearson r (predicted vs. observed tile-mean Δhm) | 0.709 |
| Coverage rate (q025 ≤ obs ≤ q975), all bins | 0.751 (target ≈ 0.95) |
...
| `[ -0.005, +0.005]` | 789,483 | 0.827 |
| `[ +0.005, +0.020]` | 123,519 | 0.578 |
| `[ +0.020, +0.100]` | 103,808 | 0.592 |
| `[ +0.100, +0.200]` | 10,953 | 0.480 |
| `[ +0.200, +0.400]` | 1,746 | 0.151 |
...
- Predicted tail mass: 1412.2043
- **Ratio (pred / obs):** **1.064** (<<1 = under-predicting tail; ~1 = calibrated; >1 = over)

### Tail exceedance (deterministic + q975 ensemble support)

| Threshold | n(obs>t) | n(pred>t) | POD | CSI | FAR | q975 soft-POD |
|---|---|---|---|---|---|---|
| +0.050 |     45,659 |     92,919 | 0.462 | 0.179 | 0.773 | 0.911 |
| +0.100 |     12,833 |     14,771 | 0.187 | 0.095 | 0.838 | 0.710 |
| +0.200 |      1,880 |        488 | 0.088 | 0.075 | 0.662 | 0.306 |
| +0.400 |        134 |         15 | 0.097 | 0.096 | 0.133 | 0.127 |

![Q-Q max-of-field](../outputs/diffusion_v36o/qq_max_of_field.png)
![Q-Q mean-of-field](../outputs/diffusion_v36o/qq_mean_of_field.png)

## Figures

- Map comparison: ![](../outputs/diffusion_v36o/map_comparison.png)
- Tile-level summaries: ![](../outputs/diffusion_v36o/tile_metrics.png)
