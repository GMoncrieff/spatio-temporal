...
| Tile-mean MAE (95th %ile) | 0.0380 |
| Histogram intersection (median) | **0.555** |
| Histogram intersection (mean) | 0.532 |
| Pearson r (predicted vs. observed tile-mean Δhm) | 0.701 |
| Coverage rate (q025 ≤ obs ≤ q975), all bins | 0.720 (target ≈ 0.95) |
...
| `[ -0.005, +0.005]` | 789,483 | 0.792 |
| `[ +0.005, +0.020]` | 123,519 | 0.543 |
...
- Predicted tail mass: 1707.1223
- **Ratio (pred / obs):** **1.286** (<<1 = under-predicting tail; ~1 = calibrated; >1 = over)

### Tail exceedance (deterministic + q975 ensemble support)

| Threshold | n(obs>t) | n(pred>t) | POD | CSI | FAR | q975 soft-POD |
|---|---|---|---|---|---|---|
| +0.050 |     45,659 |    103,566 | 0.480 | 0.172 | 0.788 | 0.930 |
| +0.100 |     12,833 |     18,401 | 0.192 | 0.085 | 0.866 | 0.788 |
