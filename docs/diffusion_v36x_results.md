...
| Tile-mean MAE (95th %ile) | 0.0356 |
| Histogram intersection (median) | **0.637** |
| Histogram intersection (mean) | 0.603 |
| Pearson r (predicted vs. observed tile-mean Δhm) | 0.709 |
| Coverage rate (q025 ≤ obs ≤ q975), all bins | 0.839 (target ≈ 0.95) |
...
|---|---:|---:|
| `[ -1.000, -0.005]` | 59,954 | 0.513 |
| `[ -0.005, +0.005]` | 789,483 | 0.917 |
| `[ +0.005, +0.020]` | 123,519 | 0.658 |
| `[ +0.020, +0.100]` | 103,808 | 0.687 |
| `[ +0.100, +0.200]` | 10,953 | 0.601 |
| `[ +0.200, +0.400]` | 1,746 | 0.212 |
...
|---|---|---|---|---|---|---|
| +0.050 |     45,659 |     93,491 | 0.463 | 0.179 | 0.774 | 0.961 |
| +0.100 |     12,833 |     14,704 | 0.184 | 0.094 | 0.839 | 0.811 |
| +0.200 |      1,880 |        472 | 0.086 | 0.074 | 0.657 | 0.393 |
| +0.400 |        134 |         14 | 0.090 | 0.088 | 0.143 | 0.127 |

![Q-Q max-of-field](../outputs/diffusion_v36x/qq_max_of_field.png)
![Q-Q mean-of-field](../outputs/diffusion_v36x/qq_mean_of_field.png)

## Figures

- Map comparison: ![](../outputs/diffusion_v36x/map_comparison.png)
- Tile-level summaries: ![](../outputs/diffusion_v36x/tile_metrics.png)
