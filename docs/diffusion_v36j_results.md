...
| Tile-mean MAE (95th %ile) | 0.0374 |
| Histogram intersection (median) | **0.527** |
| Histogram intersection (mean) | 0.511 |
| Pearson r (predicted vs. observed tile-mean Δhm) | 0.701 |
| Coverage rate (q025 ≤ obs ≤ q975), all bins | 0.667 (target ≈ 0.95) |
...
|---|---:|---:|
| `[ -1.000, -0.005]` | 59,954 | 0.376 |
| `[ -0.005, +0.005]` | 789,483 | 0.732 |
| `[ +0.005, +0.020]` | 123,519 | 0.495 |
| `[ +0.020, +0.100]` | 103,808 | 0.560 |
| `[ +0.100, +0.200]` | 10,953 | 0.595 |
| `[ +0.200, +0.400]` | 1,746 | 0.244 |
...
|---|---|---|---|---|---|---|
| +0.050 |     45,659 |    102,620 | 0.477 | 0.172 | 0.788 | 0.908 |
| +0.100 |     12,833 |     18,081 | 0.192 | 0.087 | 0.864 | 0.771 |
| +0.200 |      1,880 |        562 | 0.089 | 0.073 | 0.703 | 0.416 |
| +0.400 |        134 |         15 | 0.097 | 0.096 | 0.133 | 0.142 |

![Q-Q max-of-field](../outputs/diffusion_v36j/qq_max_of_field.png)
![Q-Q mean-of-field](../outputs/diffusion_v36j/qq_mean_of_field.png)

## Figures

- Map comparison: ![](../outputs/diffusion_v36j/map_comparison.png)
- Tile-level summaries: ![](../outputs/diffusion_v36j/tile_metrics.png)
