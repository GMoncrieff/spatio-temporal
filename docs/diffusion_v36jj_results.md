...
| Tile-mean MAE (mean) | 0.0100 |
| Tile-mean MAE (95th %ile) | 0.0304 |
| Histogram intersection (median) | **0.535** |
| Histogram intersection (mean) | 0.510 |
| Pearson r (predicted vs. observed tile-mean Δhm) | 0.704 |
| Coverage rate (q025 ≤ obs ≤ q975), all bins | 0.884 (target ≈ 0.95) |
...
| `[ +0.005, +0.020]` | 123,519 | 0.735 |
| `[ +0.020, +0.100]` | 103,808 | 0.748 |
| `[ +0.100, +0.200]` | 10,953 | 0.563 |
...
- Predicted tail mass: 1008.8847
- **Ratio (pred / obs):** **0.760** (<<1 = under-predicting tail; ~1 = calibrated; >1 = over)

### Tail exceedance (deterministic + q975 ensemble support)

| Threshold | n(obs>t) | n(pred>t) | POD | CSI | FAR | q975 soft-POD |
|---|---|---|---|---|---|---|
| +0.050 |     45,659 |     71,191 | 0.384 | 0.177 | 0.754 | 0.952 |
| +0.100 |     12,833 |     10,362 | 0.151 | 0.091 | 0.813 | 0.783 |
| +0.200 |      1,880 |        385 | 0.076 | 0.067 | 0.629 | 0.330 |
| +0.400 |        134 |         13 | 0.082 | 0.081 | 0.154 | 0.134 |

![Q-Q max-of-field](../outputs/diffusion_v36jj/qq_max_of_field.png)
![Q-Q mean-of-field](../outputs/diffusion_v36jj/qq_mean_of_field.png)

## Figures

- Map comparison: ![](../outputs/diffusion_v36jj/map_comparison.png)
- Tile-level summaries: ![](../outputs/diffusion_v36jj/tile_metrics.png)
