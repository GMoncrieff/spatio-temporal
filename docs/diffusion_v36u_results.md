...
| Tile-mean MAE (median) | **0.0059** |
| Tile-mean MAE (mean) | 0.0104 |
| Tile-mean MAE (95th %ile) | 0.0367 |
| Histogram intersection (median) | **0.621** |
| Histogram intersection (mean) | 0.591 |
| Pearson r (predicted vs. observed tile-mean Δhm) | 0.709 |
| Coverage rate (q025 ≤ obs ≤ q975), all bins | 0.820 (target ≈ 0.95) |
...
|---|---:|---:|
| `[ -1.000, -0.005]` | 59,954 | 0.486 |
| `[ -0.005, +0.005]` | 789,483 | 0.902 |
| `[ +0.005, +0.020]` | 123,519 | 0.637 |
| `[ +0.020, +0.100]` | 103,808 | 0.651 |
| `[ +0.100, +0.200]` | 10,953 | 0.507 |
| `[ +0.200, +0.400]` | 1,746 | 0.163 |
...
|---|---|---|---|---|---|---|
| +0.050 |     45,659 |     95,528 | 0.467 | 0.178 | 0.777 | 0.936 |
| +0.100 |     12,833 |     14,850 | 0.189 | 0.096 | 0.837 | 0.745 |
| +0.200 |      1,880 |        493 | 0.087 | 0.074 | 0.669 | 0.323 |
| +0.400 |        134 |         15 | 0.097 | 0.096 | 0.133 | 0.149 |

![Q-Q max-of-field](../outputs/diffusion_v36u/qq_max_of_field.png)
![Q-Q mean-of-field](../outputs/diffusion_v36u/qq_mean_of_field.png)

## Figures

- Map comparison: ![](../outputs/diffusion_v36u/map_comparison.png)
- Tile-level summaries: ![](../outputs/diffusion_v36u/tile_metrics.png)
