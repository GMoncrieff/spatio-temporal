...
| Histogram intersection (mean) | 0.609 |
| Pearson r (predicted vs. observed tile-mean Δhm) | 0.709 |
| Coverage rate (q025 ≤ obs ≤ q975), all bins | 0.850 (target ≈ 0.95) |
...
| `[ +0.020, +0.100]` | 103,808 | 0.711 |
| `[ +0.100, +0.200]` | 10,953 | 0.718 |
| `[ +0.200, +0.400]` | 1,746 | 0.290 |
...
- Predicted tail mass: 1441.9296
- **Ratio (pred / obs):** **1.086** (<<1 = under-predicting tail; ~1 = calibrated; >1 = over)

### Tail exceedance (deterministic + q975 ensemble support)

| Threshold | n(obs>t) | n(pred>t) | POD | CSI | FAR | q975 soft-POD |
|---|---|---|---|---|---|---|
| +0.050 |     45,659 |     95,119 | 0.464 | 0.177 | 0.777 | 0.976 |
| +0.100 |     12,833 |     15,122 | 0.186 | 0.093 | 0.842 | 0.877 |
| +0.200 |      1,880 |        482 | 0.088 | 0.075 | 0.658 | 0.503 |
| +0.400 |        134 |         13 | 0.090 | 0.089 | 0.077 | 0.157 |

![Q-Q max-of-field](../outputs/diffusion_v36z/qq_max_of_field.png)
![Q-Q mean-of-field](../outputs/diffusion_v36z/qq_mean_of_field.png)

## Figures

- Map comparison: ![](../outputs/diffusion_v36z/map_comparison.png)
- Tile-level summaries: ![](../outputs/diffusion_v36z/tile_metrics.png)
