...
| Tile-mean MAE (95th %ile) | 0.0364 |
| Histogram intersection (median) | **0.643** |
| Histogram intersection (mean) | 0.608 |
| Pearson r (predicted vs. observed tile-mean Δhm) | 0.704 |
| Coverage rate (q025 ≤ obs ≤ q975), all bins | 0.851 (target ≈ 0.95) |
...
|---|---:|---:|
| `[ -1.000, -0.005]` | 59,954 | 0.527 |
| `[ -0.005, +0.005]` | 789,483 | 0.924 |
| `[ +0.005, +0.020]` | 123,519 | 0.670 |
| `[ +0.020, +0.100]` | 103,808 | 0.714 |
| `[ +0.100, +0.200]` | 10,953 | 0.759 |
| `[ +0.200, +0.400]` | 1,746 | 0.340 |
| `[ +0.400, +0.600]` | 127 | 0.134 |
| `[ +0.600, +1.000]` | 7 | 0.143 |
...
|---|---|---|---|---|---|---|
| +0.050 |     45,659 |     97,564 | 0.464 | 0.174 | 0.783 | 0.979 |
| +0.100 |     12,833 |     16,134 | 0.186 | 0.090 | 0.852 | 0.898 |
| +0.200 |      1,880 |        497 | 0.087 | 0.074 | 0.672 | 0.552 |
| +0.400 |        134 |         13 | 0.090 | 0.089 | 0.077 | 0.187 |

![Q-Q max-of-field](../outputs/diffusion_v36aa/qq_max_of_field.png)
![Q-Q mean-of-field](../outputs/diffusion_v36aa/qq_mean_of_field.png)

## Figures

- Map comparison: ![](../outputs/diffusion_v36aa/map_comparison.png)
- Tile-level summaries: ![](../outputs/diffusion_v36aa/tile_metrics.png)
