...
| Tile-mean MAE (median) | **0.0122** |
| Tile-mean MAE (mean) | 0.0150 |
| Tile-mean MAE (95th %ile) | 0.0353 |
| Histogram intersection (median) | **0.086** |
| Histogram intersection (mean) | 0.190 |
| Pearson r (predicted vs. observed tile-mean Δhm) | 0.719 |
| Coverage rate (q025 ≤ obs ≤ q975), all bins | 0.084 (target ≈ 0.95) |
...
|---|---:|---:|
| `[ -1.000, -0.005]` | 59,954 | 0.000 |
| `[ -0.005, +0.005]` | 789,483 | 0.000 |
| `[ +0.005, +0.020]` | 123,519 | 0.222 |
| `[ +0.020, +0.100]` | 103,808 | 0.587 |
| `[ +0.100, +0.200]` | 10,953 | 0.284 |
| `[ +0.200, +0.400]` | 1,746 | 0.082 |
| `[ +0.400, +0.600]` | 127 | 0.063 |
| `[ +0.600, +1.000]` | 7 | 0.000 |
...
- Predicted tail mass: 1320.2144
- **Ratio (pred / obs):** **0.995** (<<1 = under-predicting tail; ~1 = calibrated; >1 = over)

### Tail exceedance (deterministic + q975 ensemble support)

| Threshold | n(obs>t) | n(pred>t) | POD | CSI | FAR | q975 soft-POD |
|---|---|---|---|---|---|---|
| +0.050 |     45,659 |     86,014 | 0.453 | 0.186 | 0.759 | 0.874 |
| +0.100 |     12,833 |     13,911 | 0.182 | 0.096 | 0.832 | 0.561 |
| +0.200 |      1,880 |        446 | 0.085 | 0.073 | 0.643 | 0.214 |
| +0.400 |        134 |         14 | 0.090 | 0.088 | 0.143 | 0.119 |

![Q-Q max-of-field](../outputs/diffusion_v36oo/qq_max_of_field.png)
![Q-Q mean-of-field](../outputs/diffusion_v36oo/qq_mean_of_field.png)

## Figures

- Map comparison: ![](../outputs/diffusion_v36oo/map_comparison.png)
- Tile-level summaries: ![](../outputs/diffusion_v36oo/tile_metrics.png)
