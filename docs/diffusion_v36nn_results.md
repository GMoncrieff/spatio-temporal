...
| Tile-mean MAE (median) | **0.0123** |
| Tile-mean MAE (mean) | 0.0156 |
| Tile-mean MAE (95th %ile) | 0.0377 |
| Histogram intersection (median) | **0.086** |
| Histogram intersection (mean) | 0.192 |
| Pearson r (predicted vs. observed tile-mean Δhm) | 0.715 |
| Coverage rate (q025 ≤ obs ≤ q975), all bins | 0.099 (target ≈ 0.95) |
...
| `[ +0.005, +0.020]` | 123,519 | 0.227 |
| `[ +0.020, +0.100]` | 103,808 | 0.690 |
| `[ +0.100, +0.200]` | 10,953 | 0.657 |
| `[ +0.200, +0.400]` | 1,746 | 0.242 |
| `[ +0.400, +0.600]` | 127 | 0.102 |
| `[ +0.600, +1.000]` | 7 | 0.143 |
...
- Predicted tail mass: 1404.8038
- **Ratio (pred / obs):** **1.058** (<<1 = under-predicting tail; ~1 = calibrated; >1 = over)

### Tail exceedance (deterministic + q975 ensemble support)

| Threshold | n(obs>t) | n(pred>t) | POD | CSI | FAR | q975 soft-POD |
|---|---|---|---|---|---|---|
| +0.050 |     45,659 |     92,583 | 0.461 | 0.180 | 0.773 | 0.968 |
| +0.100 |     12,833 |     14,744 | 0.184 | 0.094 | 0.840 | 0.845 |
| +0.200 |      1,880 |        483 | 0.087 | 0.074 | 0.663 | 0.438 |
| +0.400 |        134 |         15 | 0.097 | 0.096 | 0.133 | 0.142 |

![Q-Q max-of-field](../outputs/diffusion_v36nn/qq_max_of_field.png)
![Q-Q mean-of-field](../outputs/diffusion_v36nn/qq_mean_of_field.png)

## Figures

- Map comparison: ![](../outputs/diffusion_v36nn/map_comparison.png)
- Tile-level summaries: ![](../outputs/diffusion_v36nn/tile_metrics.png)
