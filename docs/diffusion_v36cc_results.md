...
| Tile-mean MAE (mean) | 0.0108 |
| Tile-mean MAE (95th %ile) | 0.0342 |
| Histogram intersection (median) | **0.458** |
| Histogram intersection (mean) | 0.447 |
| Pearson r (predicted vs. observed tile-mean Δhm) | 0.703 |
| Coverage rate (q025 ≤ obs ≤ q975), all bins | 0.780 (target ≈ 0.95) |
...
|---|---:|---:|
| `[ -1.000, -0.005]` | 59,954 | 0.506 |
| `[ -0.005, +0.005]` | 789,483 | 0.846 |
| `[ +0.005, +0.020]` | 123,519 | 0.616 |
| `[ +0.020, +0.100]` | 103,808 | 0.657 |
| `[ +0.100, +0.200]` | 10,953 | 0.622 |
...
- Predicted tail mass: 1307.4628
- **Ratio (pred / obs):** **0.985** (<<1 = under-predicting tail; ~1 = calibrated; >1 = over)

### Tail exceedance (deterministic + q975 ensemble support)

| Threshold | n(obs>t) | n(pred>t) | POD | CSI | FAR | q975 soft-POD |
|---|---|---|---|---|---|---|
| +0.050 |     45,659 |     86,738 | 0.442 | 0.180 | 0.767 | 0.926 |
| +0.100 |     12,833 |     13,684 | 0.177 | 0.094 | 0.834 | 0.799 |
| +0.200 |      1,880 |        471 | 0.085 | 0.073 | 0.662 | 0.435 |
| +0.400 |        134 |         13 | 0.090 | 0.089 | 0.077 | 0.149 |

![Q-Q max-of-field](../outputs/diffusion_v36cc/qq_max_of_field.png)
![Q-Q mean-of-field](../outputs/diffusion_v36cc/qq_mean_of_field.png)

## Figures

- Map comparison: ![](../outputs/diffusion_v36cc/map_comparison.png)
- Tile-level summaries: ![](../outputs/diffusion_v36cc/tile_metrics.png)
