...
| Tile-mean MAE (median) | **0.0069** |
| Tile-mean MAE (mean) | 0.0099 |
| Tile-mean MAE (95th %ile) | 0.0302 |
| Histogram intersection (median) | **0.543** |
| Histogram intersection (mean) | 0.512 |
| Pearson r (predicted vs. observed tile-mean Δhm) | 0.708 |
| Coverage rate (q025 ≤ obs ≤ q975), all bins | 0.878 (target ≈ 0.95) |
...
|---|---:|---:|
| `[ -1.000, -0.005]` | 59,954 | 0.650 |
| `[ -0.005, +0.005]` | 789,483 | 0.948 |
| `[ +0.005, +0.020]` | 123,519 | 0.732 |
| `[ +0.020, +0.100]` | 103,808 | 0.710 |
| `[ +0.100, +0.200]` | 10,953 | 0.398 |
| `[ +0.200, +0.400]` | 1,746 | 0.112 |
...
- Predicted tail mass: 978.8678
- **Ratio (pred / obs):** **0.738** (<<1 = under-predicting tail; ~1 = calibrated; >1 = over)

### Tail exceedance (deterministic + q975 ensemble support)

| Threshold | n(obs>t) | n(pred>t) | POD | CSI | FAR | q975 soft-POD |
|---|---|---|---|---|---|---|
| +0.050 |     45,659 |     68,492 | 0.381 | 0.180 | 0.746 | 0.916 |
| +0.100 |     12,833 |     10,043 | 0.150 | 0.092 | 0.808 | 0.659 |
| +0.200 |      1,880 |        393 | 0.076 | 0.067 | 0.636 | 0.251 |
| +0.400 |        134 |         12 | 0.082 | 0.081 | 0.083 | 0.134 |

![Q-Q max-of-field](../outputs/diffusion_v36dd/qq_max_of_field.png)
![Q-Q mean-of-field](../outputs/diffusion_v36dd/qq_mean_of_field.png)

## Figures

- Map comparison: ![](../outputs/diffusion_v36dd/map_comparison.png)
- Tile-level summaries: ![](../outputs/diffusion_v36dd/tile_metrics.png)
