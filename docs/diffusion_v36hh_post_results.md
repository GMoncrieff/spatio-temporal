...
| Tile-mean MAE (median) | **0.0026** |
| Tile-mean MAE (mean) | 0.0071 |
| Tile-mean MAE (95th %ile) | 0.0296 |
| Histogram intersection (median) | **0.836** |
| Histogram intersection (mean) | 0.785 |
| Pearson r (predicted vs. observed tile-mean Δhm) | 0.712 |
| Coverage rate (q025 ≤ obs ≤ q975), all bins | 0.757 (target ≈ 0.95) |
...
|---|---:|---:|
| `[ -1.000, -0.005]` | 59,954 | 0.530 |
| `[ -0.005, +0.005]` | 789,483 | 0.772 |
| `[ +0.005, +0.020]` | 123,519 | 0.782 |
...
![Q-Q max-of-field](../outputs/diffusion_v36hh_post/qq_max_of_field.png)
![Q-Q mean-of-field](../outputs/diffusion_v36hh_post/qq_mean_of_field.png)

## Figures

- Map comparison: ![](../outputs/diffusion_v36hh_post/map_comparison.png)
- Tile-level summaries: ![](../outputs/diffusion_v36hh_post/tile_metrics.png)
