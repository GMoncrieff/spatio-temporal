...
| Histogram intersection (median) | **0.539** |
| Histogram intersection (mean) | 0.512 |
| Pearson r (predicted vs. observed tile-mean Δhm) | 0.701 |
| Coverage rate (q025 ≤ obs ≤ q975), all bins | 0.776 (target ≈ 0.95) |
...
| `[ -0.005, +0.005]` | 789,483 | 0.861 |
| `[ +0.005, +0.020]` | 123,519 | 0.550 |
| `[ +0.020, +0.100]` | 103,808 | 0.581 |
| `[ +0.100, +0.200]` | 10,953 | 0.526 |
| `[ +0.200, +0.400]` | 1,746 | 0.192 |
...
- Predicted tail mass: 1662.8757
- **Ratio (pred / obs):** **1.253** (<<1 = under-predicting tail; ~1 = calibrated; >1 = over)

### Tail exceedance (deterministic + q975 ensemble support)

| Threshold | n(obs>t) | n(pred>t) | POD | CSI | FAR | q975 soft-POD |
|---|---|---|---|---|---|---|
| +0.050 |     45,659 |     98,296 | 0.470 | 0.175 | 0.782 | 0.915 |
| +0.100 |     12,833 |     18,066 | 0.198 | 0.090 | 0.859 | 0.739 |
| +0.200 |      1,880 |        631 | 0.097 | 0.079 | 0.710 | 0.348 |
| +0.400 |        134 |         19 | 0.097 | 0.093 | 0.316 | 0.142 |

![Q-Q max-of-field](../outputs/diffusion_v36g/qq_max_of_field.png)

## Figures

- Map comparison: ![](../outputs/diffusion_v36g/map_comparison.png)
- Tile-level summaries: ![](../outputs/diffusion_v36g/tile_metrics.png)
