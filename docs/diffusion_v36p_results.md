...
| Tile-mean MAE (median) | **0.0065** |
| Tile-mean MAE (mean) | 0.0106 |
| Tile-mean MAE (95th %ile) | 0.0358 |
| Histogram intersection (median) | **0.537** |
| Histogram intersection (mean) | 0.519 |
| Pearson r (predicted vs. observed tile-mean Δhm) | 0.708 |
| Coverage rate (q025 ≤ obs ≤ q975), all bins | 0.745 (target ≈ 0.95) |
...
|---|---:|---:|
| `[ -1.000, -0.005]` | 59,954 | 0.439 |
| `[ -0.005, +0.005]` | 789,483 | 0.821 |
| `[ +0.005, +0.020]` | 123,519 | 0.573 |
| `[ +0.020, +0.100]` | 103,808 | 0.587 |
| `[ +0.100, +0.200]` | 10,953 | 0.485 |
| `[ +0.200, +0.400]` | 1,746 | 0.167 |
...
- Predicted tail mass: 1426.6006
- **Ratio (pred / obs):** **1.075** (<<1 = under-predicting tail; ~1 = calibrated; >1 = over)

### Tail exceedance (deterministic + q975 ensemble support)

| Threshold | n(obs>t) | n(pred>t) | POD | CSI | FAR | q975 soft-POD |
|---|---|---|---|---|---|---|
| +0.050 |     45,659 |     93,280 | 0.464 | 0.180 | 0.773 | 0.907 |
| +0.100 |     12,833 |     14,968 | 0.187 | 0.094 | 0.840 | 0.713 |
| +0.200 |      1,880 |        504 | 0.090 | 0.076 | 0.665 | 0.306 |
| +0.400 |        134 |         14 | 0.090 | 0.088 | 0.143 | 0.142 |

![Q-Q max-of-field](../outputs/diffusion_v36p/qq_max_of_field.png)
![Q-Q mean-of-field](../outputs/diffusion_v36p/qq_mean_of_field.png)

## Figures

- Map comparison: ![](../outputs/diffusion_v36p/map_comparison.png)
- Tile-level summaries: ![](../outputs/diffusion_v36p/tile_metrics.png)
