...
| Histogram intersection (median) | **0.583** |
| Histogram intersection (mean) | 0.550 |
| Pearson r (predicted vs. observed tile-mean Δhm) | 0.708 |
| Coverage rate (q025 ≤ obs ≤ q975), all bins | 0.867 (target ≈ 0.95) |
...
|---|---:|---:|
| `[ -1.000, -0.005]` | 59,954 | 0.603 |
| `[ -0.005, +0.005]` | 789,483 | 0.938 |
| `[ +0.005, +0.020]` | 123,519 | 0.703 |
| `[ +0.020, +0.100]` | 103,808 | 0.721 |
| `[ +0.100, +0.200]` | 10,953 | 0.558 |
| `[ +0.200, +0.400]` | 1,746 | 0.166 |
...
- Predicted tail mass: 1134.0990
- **Ratio (pred / obs):** **0.854** (<<1 = under-predicting tail; ~1 = calibrated; >1 = over)

### Tail exceedance (deterministic + q975 ensemble support)

| Threshold | n(obs>t) | n(pred>t) | POD | CSI | FAR | q975 soft-POD |
|---|---|---|---|---|---|---|
| +0.050 |     45,659 |     78,067 | 0.413 | 0.180 | 0.759 | 0.954 |
| +0.100 |     12,833 |     11,771 | 0.164 | 0.093 | 0.821 | 0.788 |
| +0.200 |      1,880 |        420 | 0.081 | 0.071 | 0.638 | 0.334 |
| +0.400 |        134 |         13 | 0.090 | 0.089 | 0.077 | 0.134 |

![Q-Q max-of-field](../outputs/diffusion_v36ii/qq_max_of_field.png)
![Q-Q mean-of-field](../outputs/diffusion_v36ii/qq_mean_of_field.png)

## Figures

- Map comparison: ![](../outputs/diffusion_v36ii/map_comparison.png)
- Tile-level summaries: ![](../outputs/diffusion_v36ii/tile_metrics.png)
