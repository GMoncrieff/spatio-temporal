...
| Tile-mean MAE (median) | **0.0061** |
| Tile-mean MAE (mean) | 0.0105 |
| Tile-mean MAE (95th %ile) | 0.0370 |
| Histogram intersection (median) | **0.621** |
| Histogram intersection (mean) | 0.588 |
| Pearson r (predicted vs. observed tile-mean Δhm) | 0.704 |
...
| `[ -0.005, +0.005]` | 789,483 | 0.893 |
| `[ +0.005, +0.020]` | 123,519 | 0.622 |
| `[ +0.020, +0.100]` | 103,808 | 0.647 |
| `[ +0.100, +0.200]` | 10,953 | 0.562 |
| `[ +0.200, +0.400]` | 1,746 | 0.200 |
...
- Predicted tail mass: 1520.4348
- **Ratio (pred / obs):** **1.146** (<<1 = under-predicting tail; ~1 = calibrated; >1 = over)

### Tail exceedance (deterministic + q975 ensemble support)

| Threshold | n(obs>t) | n(pred>t) | POD | CSI | FAR | q975 soft-POD |
|---|---|---|---|---|---|---|
| +0.050 |     45,659 |     97,903 | 0.471 | 0.176 | 0.781 | 0.940 |
| +0.100 |     12,833 |     16,089 | 0.190 | 0.092 | 0.848 | 0.775 |
| +0.200 |      1,880 |        510 | 0.087 | 0.073 | 0.680 | 0.365 |
| +0.400 |        134 |         14 | 0.090 | 0.088 | 0.143 | 0.134 |

![Q-Q max-of-field](../outputs/diffusion_v36w/qq_max_of_field.png)
![Q-Q mean-of-field](../outputs/diffusion_v36w/qq_mean_of_field.png)

## Figures

- Map comparison: ![](../outputs/diffusion_v36w/map_comparison.png)
- Tile-level summaries: ![](../outputs/diffusion_v36w/tile_metrics.png)
