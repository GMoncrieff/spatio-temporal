...
| Tile-mean MAE (median) | **0.0071** |
| Tile-mean MAE (mean) | 0.0113 |
| Tile-mean MAE (95th %ile) | 0.0384 |
| Histogram intersection (median) | **0.520** |
| Histogram intersection (mean) | 0.506 |
| Pearson r (predicted vs. observed tile-mean Δhm) | 0.698 |
| Coverage rate (q025 ≤ obs ≤ q975), all bins | 0.700 (target ≈ 0.95) |
...
|---|---:|---:|
| `[ -1.000, -0.005]` | 59,954 | 0.392 |
| `[ -0.005, +0.005]` | 789,483 | 0.772 |
| `[ +0.005, +0.020]` | 123,519 | 0.512 |
| `[ +0.020, +0.100]` | 103,808 | 0.575 |
| `[ +0.100, +0.200]` | 10,953 | 0.605 |
| `[ +0.200, +0.400]` | 1,746 | 0.251 |
...
- Predicted tail mass: 1701.3311
- **Ratio (pred / obs):** **1.282** (<<1 = under-predicting tail; ~1 = calibrated; >1 = over)

### Tail exceedance (deterministic + q975 ensemble support)

| Threshold | n(obs>t) | n(pred>t) | POD | CSI | FAR | q975 soft-POD |
|---|---|---|---|---|---|---|
| +0.050 |     45,659 |    103,061 | 0.479 | 0.172 | 0.788 | 0.917 |
| +0.100 |     12,833 |     18,305 | 0.192 | 0.086 | 0.865 | 0.780 |
| +0.200 |      1,880 |        568 | 0.086 | 0.071 | 0.715 | 0.422 |
| +0.400 |        134 |         15 | 0.097 | 0.096 | 0.133 | 0.127 |

![Q-Q max-of-field](../outputs/diffusion_v36n/qq_max_of_field.png)
![Q-Q mean-of-field](../outputs/diffusion_v36n/qq_mean_of_field.png)

## Figures

- Map comparison: ![](../outputs/diffusion_v36n/map_comparison.png)
- Tile-level summaries: ![](../outputs/diffusion_v36n/tile_metrics.png)
