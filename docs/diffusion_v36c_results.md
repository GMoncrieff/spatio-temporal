...
| Tile-mean MAE (mean) | 0.0102 |
| Tile-mean MAE (95th %ile) | 0.0344 |
| Histogram intersection (median) | **0.574** |
| Histogram intersection (mean) | 0.544 |
| Pearson r (predicted vs. observed tile-mean Δhm) | 0.709 |
| Coverage rate (q025 ≤ obs ≤ q975), all bins | 0.771 (target ≈ 0.95) |
...
|---|---:|---:|
| `[ -1.000, -0.005]` | 59,954 | 0.463 |
| `[ -0.005, +0.005]` | 789,483 | 0.853 |
| `[ +0.005, +0.020]` | 123,519 | 0.582 |
| `[ +0.020, +0.100]` | 103,808 | 0.593 |
| `[ +0.100, +0.200]` | 10,953 | 0.426 |
| `[ +0.200, +0.400]` | 1,746 | 0.125 |
...
- Predicted tail mass: 1305.0000
- **Ratio (pred / obs):** **0.983** (<<1 = under-predicting tail; ~1 = calibrated; >1 = over)

### Tail exceedance (deterministic + q975 ensemble support)

| Threshold | n(obs>t) | n(pred>t) | POD | CSI | FAR | q975 soft-POD |
|---|---|---|---|---|---|---|
| +0.050 |     45,659 |     87,347 | 0.446 | 0.181 | 0.767 | 0.900 |
| +0.100 |     12,833 |     13,600 | 0.178 | 0.095 | 0.832 | 0.673 |
| +0.200 |      1,880 |        478 | 0.084 | 0.071 | 0.672 | 0.270 |
| +0.400 |        134 |         14 | 0.097 | 0.096 | 0.071 | 0.112 |

![Q-Q max-of-field](../outputs/diffusion_v36c/qq_max_of_field.png)

## Figures

- Map comparison: ![](../outputs/diffusion_v36c/map_comparison.png)
- Tile-level summaries: ![](../outputs/diffusion_v36c/tile_metrics.png)
...
![](../outputs/diffusion_v36c/samples_vs_observed.png)
