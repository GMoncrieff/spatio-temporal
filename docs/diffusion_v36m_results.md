...
| Tile-mean MAE (median) | **0.0068** |
| Tile-mean MAE (mean) | 0.0112 |
| Tile-mean MAE (95th %ile) | 0.0378 |
| Histogram intersection (median) | **0.547** |
| Histogram intersection (mean) | 0.527 |
| Pearson r (predicted vs. observed tile-mean Δhm) | 0.699 |
| Coverage rate (q025 ≤ obs ≤ q975), all bins | 0.719 (target ≈ 0.95) |
...
|---|---:|---:|
| `[ -1.000, -0.005]` | 59,954 | 0.394 |
| `[ -0.005, +0.005]` | 789,483 | 0.791 |
| `[ +0.005, +0.020]` | 123,519 | 0.539 |
| `[ +0.020, +0.100]` | 103,808 | 0.588 |
| `[ +0.100, +0.200]` | 10,953 | 0.611 |
| `[ +0.200, +0.400]` | 1,746 | 0.254 |
...
- Predicted tail mass: 1710.8442
- **Ratio (pred / obs):** **1.289** (<<1 = under-predicting tail; ~1 = calibrated; >1 = over)

### Tail exceedance (deterministic + q975 ensemble support)

| Threshold | n(obs>t) | n(pred>t) | POD | CSI | FAR | q975 soft-POD |
|---|---|---|---|---|---|---|
| +0.050 |     45,659 |    103,447 | 0.481 | 0.173 | 0.788 | 0.927 |
| +0.100 |     12,833 |     18,433 | 0.193 | 0.086 | 0.865 | 0.790 |
| +0.200 |      1,880 |        581 | 0.089 | 0.073 | 0.711 | 0.436 |
| +0.400 |        134 |         15 | 0.090 | 0.088 | 0.200 | 0.134 |

![Q-Q max-of-field](../outputs/diffusion_v36m/qq_max_of_field.png)
![Q-Q mean-of-field](../outputs/diffusion_v36m/qq_mean_of_field.png)

## Figures

- Map comparison: ![](../outputs/diffusion_v36m/map_comparison.png)
- Tile-level summaries: ![](../outputs/diffusion_v36m/tile_metrics.png)
