...
| Tile-mean MAE (95th %ile) | 0.0318 |
| Histogram intersection (median) | **0.559** |
| Histogram intersection (mean) | 0.527 |
| Pearson r (predicted vs. observed tile-mean Δhm) | 0.703 |
| Coverage rate (q025 ≤ obs ≤ q975), all bins | 0.879 (target ≈ 0.95) |
...
|---|---:|---:|
| `[ -1.000, -0.005]` | 59,954 | 0.627 |
| `[ -0.005, +0.005]` | 789,483 | 0.944 |
| `[ +0.005, +0.020]` | 123,519 | 0.722 |
| `[ +0.020, +0.100]` | 103,808 | 0.750 |
| `[ +0.100, +0.200]` | 10,953 | 0.664 |
| `[ +0.200, +0.400]` | 1,746 | 0.234 |
...
- Predicted tail mass: 1106.4568
- **Ratio (pred / obs):** **0.834** (<<1 = under-predicting tail; ~1 = calibrated; >1 = over)

### Tail exceedance (deterministic + q975 ensemble support)

| Threshold | n(obs>t) | n(pred>t) | POD | CSI | FAR | q975 soft-POD |
|---|---|---|---|---|---|---|
| +0.050 |     45,659 |     77,564 | 0.401 | 0.175 | 0.764 | 0.964 |
| +0.100 |     12,833 |     11,346 | 0.157 | 0.091 | 0.822 | 0.840 |
| +0.200 |      1,880 |        420 | 0.079 | 0.069 | 0.648 | 0.421 |
| +0.400 |        134 |         13 | 0.090 | 0.089 | 0.077 | 0.134 |

![Q-Q max-of-field](../outputs/diffusion_v36mm/qq_max_of_field.png)
![Q-Q mean-of-field](../outputs/diffusion_v36mm/qq_mean_of_field.png)

## Figures

- Map comparison: ![](../outputs/diffusion_v36mm/map_comparison.png)
- Tile-level summaries: ![](../outputs/diffusion_v36mm/tile_metrics.png)
