...
| Coverage rate (q025 ≤ obs ≤ q975), all bins | 0.885 (target ≈ 0.95) |
...
| `[ +0.020, +0.100]` | 103,808 | 0.756 |
| `[ +0.100, +0.200]` | 10,953 | 0.610 |
| `[ +0.200, +0.400]` | 1,746 | 0.198 |
...
- Predicted tail mass: 1018.7671
- **Ratio (pred / obs):** **0.768** (<<1 = under-predicting tail; ~1 = calibrated; >1 = over)

### Tail exceedance (deterministic + q975 ensemble support)

| Threshold | n(obs>t) | n(pred>t) | POD | CSI | FAR | q975 soft-POD |
|---|---|---|---|---|---|---|
| +0.050 |     45,659 |     72,336 | 0.385 | 0.175 | 0.757 | 0.959 |
| +0.100 |     12,833 |     10,417 | 0.150 | 0.091 | 0.815 | 0.808 |
| +0.200 |      1,880 |        400 | 0.076 | 0.067 | 0.642 | 0.371 |
| +0.400 |        134 |         13 | 0.082 | 0.081 | 0.154 | 0.134 |

![Q-Q max-of-field](../outputs/diffusion_v36kk/qq_max_of_field.png)
![Q-Q mean-of-field](../outputs/diffusion_v36kk/qq_mean_of_field.png)

## Figures

- Map comparison: ![](../outputs/diffusion_v36kk/map_comparison.png)
- Tile-level summaries: ![](../outputs/diffusion_v36kk/tile_metrics.png)
