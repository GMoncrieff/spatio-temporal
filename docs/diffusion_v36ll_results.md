...
| Tile-mean MAE (median) | **0.0084** |
| Tile-mean MAE (mean) | 0.0109 |
| Tile-mean MAE (95th %ile) | 0.0290 |
| Histogram intersection (median) | **0.454** |
| Histogram intersection (mean) | 0.447 |
| Pearson r (predicted vs. observed tile-mean Δhm) | 0.691 |
| Coverage rate (q025 ≤ obs ≤ q975), all bins | 0.907 (target ≈ 0.95) |
...
|---|---:|---:|
| `[ -1.000, -0.005]` | 59,954 | 0.709 |
| `[ -0.005, +0.005]` | 789,483 | 0.960 |
| `[ +0.005, +0.020]` | 123,519 | 0.779 |
| `[ +0.020, +0.100]` | 103,808 | 0.802 |
| `[ +0.100, +0.200]` | 10,953 | 0.666 |
| `[ +0.200, +0.400]` | 1,746 | 0.238 |
...
- Predicted tail mass: 886.6799
- **Ratio (pred / obs):** **0.668** (<<1 = under-predicting tail; ~1 = calibrated; >1 = over)

### Tail exceedance (deterministic + q975 ensemble support)

| Threshold | n(obs>t) | n(pred>t) | POD | CSI | FAR | q975 soft-POD |
|---|---|---|---|---|---|---|
| +0.050 |     45,659 |     64,305 | 0.343 | 0.166 | 0.756 | 0.961 |
| +0.100 |     12,833 |      8,988 | 0.133 | 0.085 | 0.810 | 0.840 |
| +0.200 |      1,880 |        355 | 0.070 | 0.062 | 0.631 | 0.429 |
| +0.400 |        134 |         13 | 0.082 | 0.081 | 0.154 | 0.127 |

![Q-Q max-of-field](../outputs/diffusion_v36ll/qq_max_of_field.png)
![Q-Q mean-of-field](../outputs/diffusion_v36ll/qq_mean_of_field.png)

## Figures

- Map comparison: ![](../outputs/diffusion_v36ll/map_comparison.png)
- Tile-level summaries: ![](../outputs/diffusion_v36ll/tile_metrics.png)
