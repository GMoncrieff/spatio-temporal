...
| Tile-mean MAE (median) | **0.0062** |
| Tile-mean MAE (mean) | 0.0104 |
| Tile-mean MAE (95th %ile) | 0.0362 |
| Histogram intersection (median) | **0.613** |
| Histogram intersection (mean) | 0.580 |
| Pearson r (predicted vs. observed tile-mean Δhm) | 0.709 |
| Coverage rate (q025 ≤ obs ≤ q975), all bins | 0.797 (target ≈ 0.95) |
...
|---|---:|---:|
| `[ -1.000, -0.005]` | 59,954 | 0.466 |
| `[ -0.005, +0.005]` | 789,483 | 0.880 |
| `[ +0.005, +0.020]` | 123,519 | 0.607 |
| `[ +0.020, +0.100]` | 103,808 | 0.625 |
| `[ +0.100, +0.200]` | 10,953 | 0.506 |
| `[ +0.200, +0.400]` | 1,746 | 0.162 |
| `[ +0.400, +0.600]` | 127 | 0.079 |
| `[ +0.600, +1.000]` | 7 | 0.143 |
...
- Predicted tail mass: 1429.1870
- **Ratio (pred / obs):** **1.077** (<<1 = under-predicting tail; ~1 = calibrated; >1 = over)

### Tail exceedance (deterministic + q975 ensemble support)

| Threshold | n(obs>t) | n(pred>t) | POD | CSI | FAR | q975 soft-POD |
|---|---|---|---|---|---|---|
| +0.050 |     45,659 |     94,872 | 0.465 | 0.178 | 0.776 | 0.929 |
| +0.100 |     12,833 |     14,923 | 0.187 | 0.094 | 0.840 | 0.737 |
| +0.200 |      1,880 |        491 | 0.087 | 0.074 | 0.668 | 0.319 |
| +0.400 |        134 |         16 | 0.090 | 0.087 | 0.250 | 0.119 |

![Q-Q max-of-field](../outputs/diffusion_v36s/qq_max_of_field.png)
![Q-Q mean-of-field](../outputs/diffusion_v36s/qq_mean_of_field.png)

## Figures

- Map comparison: ![](../outputs/diffusion_v36s/map_comparison.png)
- Tile-level summaries: ![](../outputs/diffusion_v36s/tile_metrics.png)
