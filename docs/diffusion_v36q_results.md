...
| Tile-mean MAE (mean) | 0.0105 |
| Tile-mean MAE (95th %ile) | 0.0357 |
| Histogram intersection (median) | **0.594** |
| Histogram intersection (mean) | 0.564 |
| Pearson r (predicted vs. observed tile-mean Δhm) | 0.707 |
| Coverage rate (q025 ≤ obs ≤ q975), all bins | 0.772 (target ≈ 0.95) |
...
|---|---:|---:|
| `[ -1.000, -0.005]` | 59,954 | 0.444 |
| `[ -0.005, +0.005]` | 789,483 | 0.855 |
| `[ +0.005, +0.020]` | 123,519 | 0.581 |
| `[ +0.020, +0.100]` | 103,808 | 0.603 |
| `[ +0.100, +0.200]` | 10,953 | 0.500 |
| `[ +0.200, +0.400]` | 1,746 | 0.159 |
...
- Predicted tail mass: 1448.7778
- **Ratio (pred / obs):** **1.092** (<<1 = under-predicting tail; ~1 = calibrated; >1 = over)

### Tail exceedance (deterministic + q975 ensemble support)

| Threshold | n(obs>t) | n(pred>t) | POD | CSI | FAR | q975 soft-POD |
|---|---|---|---|---|---|---|
| +0.050 |     45,659 |     94,578 | 0.466 | 0.179 | 0.775 | 0.922 |
| +0.100 |     12,833 |     15,268 | 0.186 | 0.093 | 0.844 | 0.730 |
| +0.200 |      1,880 |        503 | 0.086 | 0.072 | 0.680 | 0.310 |
| +0.400 |        134 |         14 | 0.090 | 0.088 | 0.143 | 0.112 |

![Q-Q max-of-field](../outputs/diffusion_v36q/qq_max_of_field.png)
![Q-Q mean-of-field](../outputs/diffusion_v36q/qq_mean_of_field.png)

## Figures

- Map comparison: ![](../outputs/diffusion_v36q/map_comparison.png)
- Tile-level summaries: ![](../outputs/diffusion_v36q/tile_metrics.png)
