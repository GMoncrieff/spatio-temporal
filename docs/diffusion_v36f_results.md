...
| Histogram intersection (median) | **0.542** |
| Histogram intersection (mean) | 0.516 |
| Pearson r (predicted vs. observed tile-mean Δhm) | 0.707 |
| Coverage rate (q025 ≤ obs ≤ q975), all bins | 0.774 (target ≈ 0.95) |
...
| `[ -0.005, +0.005]` | 789,483 | 0.858 |
| `[ +0.005, +0.020]` | 123,519 | 0.551 |
| `[ +0.020, +0.100]` | 103,808 | 0.586 |
| `[ +0.100, +0.200]` | 10,953 | 0.529 |
| `[ +0.200, +0.400]` | 1,746 | 0.194 |
...
- Predicted tail mass: 1601.0432
- **Ratio (pred / obs):** **1.206** (<<1 = under-predicting tail; ~1 = calibrated; >1 = over)

### Tail exceedance (deterministic + q975 ensemble support)

| Threshold | n(obs>t) | n(pred>t) | POD | CSI | FAR | q975 soft-POD |
|---|---|---|---|---|---|---|
| +0.050 |     45,659 |     97,997 | 0.469 | 0.175 | 0.781 | 0.922 |
| +0.100 |     12,833 |     17,170 | 0.196 | 0.091 | 0.854 | 0.747 |
