...
| Tile-mean MAE (median) | **0.0095** |
| Tile-mean MAE (mean) | 0.0117 |
| Tile-mean MAE (95th %ile) | 0.0294 |
| Histogram intersection (median) | **0.395** |
| Histogram intersection (mean) | 0.404 |
| Pearson r (predicted vs. observed tile-mean Δhm) | 0.683 |
| Coverage rate (q025 ≤ obs ≤ q975), all bins | 0.918 (target ≈ 0.95) |
...
|---|---:|---:|
| `[ -1.000, -0.005]` | 59,954 | 0.742 |
| `[ -0.005, +0.005]` | 789,483 | 0.966 |
| `[ +0.005, +0.020]` | 123,519 | 0.805 |
| `[ +0.020, +0.100]` | 103,808 | 0.826 |
| `[ +0.100, +0.200]` | 10,953 | 0.666 |
| `[ +0.200, +0.400]` | 1,746 | 0.245 |
...
- Predicted tail mass: 791.6603
- **Ratio (pred / obs):** **0.596** (<<1 = under-predicting tail; ~1 = calibrated; >1 = over)

### Tail exceedance (deterministic + q975 ensemble support)

| Threshold | n(obs>t) | n(pred>t) | POD | CSI | FAR | q975 soft-POD |
|---|---|---|---|---|---|---|
| +0.050 |     45,659 |     58,367 | 0.317 | 0.162 | 0.752 | 0.961 |
| +0.100 |     12,833 |      8,001 | 0.125 | 0.083 | 0.800 | 0.837 |
| +0.200 |      1,880 |        321 | 0.069 | 0.062 | 0.598 | 0.427 |
| +0.400 |        134 |         13 | 0.082 | 0.081 | 0.154 | 0.134 |

![Q-Q max-of-field](../outputs/diffusion_v36gg/qq_max_of_field.png)
![Q-Q mean-of-field](../outputs/diffusion_v36gg/qq_mean_of_field.png)

## Figures

- Map comparison: ![](../outputs/diffusion_v36gg/map_comparison.png)
- Tile-level summaries: ![](../outputs/diffusion_v36gg/tile_metrics.png)
