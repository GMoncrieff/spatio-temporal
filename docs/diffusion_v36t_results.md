...
| Histogram intersection (mean) | 0.585 |
| Pearson r (predicted vs. observed tile-mean Δhm) | 0.709 |
| Coverage rate (q025 ≤ obs ≤ q975), all bins | 0.811 (target ≈ 0.95) |
...
|---|---:|---:|
| `[ -1.000, -0.005]` | 59,954 | 0.476 |
| `[ -0.005, +0.005]` | 789,483 | 0.894 |
| `[ +0.005, +0.020]` | 123,519 | 0.622 |
| `[ +0.020, +0.100]` | 103,808 | 0.638 |
| `[ +0.100, +0.200]` | 10,953 | 0.509 |
| `[ +0.200, +0.400]` | 1,746 | 0.172 |
...
- Predicted tail mass: 1436.3627
- **Ratio (pred / obs):** **1.082** (<<1 = under-predicting tail; ~1 = calibrated; >1 = over)

### Tail exceedance (deterministic + q975 ensemble support)

| Threshold | n(obs>t) | n(pred>t) | POD | CSI | FAR | q975 soft-POD |
|---|---|---|---|---|---|---|
| +0.050 |     45,659 |     95,222 | 0.468 | 0.179 | 0.776 | 0.931 |
| +0.100 |     12,833 |     15,027 | 0.188 | 0.095 | 0.840 | 0.739 |
| +0.200 |      1,880 |        498 | 0.087 | 0.074 | 0.671 | 0.319 |
| +0.400 |        134 |         14 | 0.097 | 0.096 | 0.071 | 0.134 |

![Q-Q max-of-field](../outputs/diffusion_v36t/qq_max_of_field.png)
![Q-Q mean-of-field](../outputs/diffusion_v36t/qq_mean_of_field.png)

## Figures

- Map comparison: ![](../outputs/diffusion_v36t/map_comparison.png)
- Tile-level summaries: ![](../outputs/diffusion_v36t/tile_metrics.png)
