...
| Tile-mean MAE (95th %ile) | 0.0295 |
| Histogram intersection (median) | **0.514** |
| Histogram intersection (mean) | 0.488 |
| Pearson r (predicted vs. observed tile-mean Δhm) | 0.705 |
...
|---|---:|---:|
| `[ -1.000, -0.005]` | 59,954 | 0.671 |
| `[ -0.005, +0.005]` | 789,483 | 0.953 |
| `[ +0.005, +0.020]` | 123,519 | 0.748 |
| `[ +0.020, +0.100]` | 103,808 | 0.736 |
| `[ +0.100, +0.200]` | 10,953 | 0.439 |
| `[ +0.200, +0.400]` | 1,746 | 0.124 |
...
- Predicted tail mass: 936.7780
- **Ratio (pred / obs):** **0.706** (<<1 = under-predicting tail; ~1 = calibrated; >1 = over)

### Tail exceedance (deterministic + q975 ensemble support)

| Threshold | n(obs>t) | n(pred>t) | POD | CSI | FAR | q975 soft-POD |
|---|---|---|---|---|---|---|
| +0.050 |     45,659 |     65,938 | 0.368 | 0.177 | 0.745 | 0.927 |
| +0.100 |     12,833 |      9,599 | 0.144 | 0.090 | 0.807 | 0.693 |
| +0.200 |      1,880 |        366 | 0.071 | 0.063 | 0.634 | 0.279 |
| +0.400 |        134 |         12 | 0.082 | 0.081 | 0.083 | 0.119 |

![Q-Q max-of-field](../outputs/diffusion_v36ff/qq_max_of_field.png)
![Q-Q mean-of-field](../outputs/diffusion_v36ff/qq_mean_of_field.png)

## Figures

- Map comparison: ![](../outputs/diffusion_v36ff/map_comparison.png)
- Tile-level summaries: ![](../outputs/diffusion_v36ff/tile_metrics.png)
