...
| Tile-mean MAE (median) | **0.0063** |
| Tile-mean MAE (mean) | 0.0097 |
| Tile-mean MAE (95th %ile) | 0.0324 |
| Histogram intersection (median) | **0.586** |
| Histogram intersection (mean) | 0.553 |
| Pearson r (predicted vs. observed tile-mean Δhm) | 0.709 |
| Coverage rate (q025 ≤ obs ≤ q975), all bins | 0.865 (target ≈ 0.95) |
...
|---|---:|---:|
| `[ -1.000, -0.005]` | 59,954 | 0.604 |
| `[ -0.005, +0.005]` | 789,483 | 0.938 |
| `[ +0.005, +0.020]` | 123,519 | 0.703 |
| `[ +0.020, +0.100]` | 103,808 | 0.708 |
| `[ +0.100, +0.200]` | 10,953 | 0.498 |
| `[ +0.200, +0.400]` | 1,746 | 0.147 |
| `[ +0.400, +0.600]` | 127 | 0.087 |
| `[ +0.600, +1.000]` | 7 | 0.143 |
...
- Predicted tail mass: 1125.7847
- **Ratio (pred / obs):** **0.848** (<<1 = under-predicting tail; ~1 = calibrated; >1 = over)

### Tail exceedance (deterministic + q975 ensemble support)

| Threshold | n(obs>t) | n(pred>t) | POD | CSI | FAR | q975 soft-POD |
|---|---|---|---|---|---|---|
| +0.050 |     45,659 |     77,069 | 0.412 | 0.181 | 0.756 | 0.944 |
| +0.100 |     12,833 |     11,746 | 0.163 | 0.093 | 0.821 | 0.743 |
| +0.200 |      1,880 |        411 | 0.078 | 0.068 | 0.645 | 0.301 |
| +0.400 |        134 |         13 | 0.090 | 0.089 | 0.077 | 0.134 |

![Q-Q max-of-field](../outputs/diffusion_v36ee/qq_max_of_field.png)
![Q-Q mean-of-field](../outputs/diffusion_v36ee/qq_mean_of_field.png)

## Figures

- Map comparison: ![](../outputs/diffusion_v36ee/map_comparison.png)
- Tile-level summaries: ![](../outputs/diffusion_v36ee/tile_metrics.png)
