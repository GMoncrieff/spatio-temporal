...
| Tile-mean MAE (95th %ile) | 0.0310 |
| Histogram intersection (median) | **0.534** |
| Histogram intersection (mean) | 0.508 |
| Pearson r (predicted vs. observed tile-mean Δhm) | 0.700 |
...
| `[ +0.100, +0.200]` | 10,953 | 0.667 |
| `[ +0.200, +0.400]` | 1,746 | 0.239 |
...
- Predicted tail mass: 1045.5934
- **Ratio (pred / obs):** **0.788** (<<1 = under-predicting tail; ~1 = calibrated; >1 = over)

### Tail exceedance (deterministic + q975 ensemble support)

| Threshold | n(obs>t) | n(pred>t) | POD | CSI | FAR | q975 soft-POD |
|---|---|---|---|---|---|---|
| +0.050 |     45,659 |     74,111 | 0.387 | 0.173 | 0.762 | 0.963 |
| +0.100 |     12,833 |     10,649 | 0.153 | 0.091 | 0.816 | 0.837 |
| +0.200 |      1,880 |        399 | 0.076 | 0.067 | 0.642 | 0.425 |
| +0.400 |        134 |         14 | 0.090 | 0.088 | 0.143 | 0.127 |

![Q-Q max-of-field](../outputs/diffusion_v36pp/qq_max_of_field.png)
![Q-Q mean-of-field](../outputs/diffusion_v36pp/qq_mean_of_field.png)

## Figures

- Map comparison: ![](../outputs/diffusion_v36pp/map_comparison.png)
- Tile-level summaries: ![](../outputs/diffusion_v36pp/tile_metrics.png)
