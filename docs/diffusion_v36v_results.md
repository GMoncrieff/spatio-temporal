...
| Tile-mean MAE (95th %ile) | 0.0367 |
| Histogram intersection (median) | **0.617** |
| Histogram intersection (mean) | 0.584 |
| Pearson r (predicted vs. observed tile-mean Δhm) | 0.707 |
| Coverage rate (q025 ≤ obs ≤ q975), all bins | 0.812 (target ≈ 0.95) |
...
|---|---:|---:|
| `[ -1.000, -0.005]` | 59,954 | 0.477 |
| `[ -0.005, +0.005]` | 789,483 | 0.894 |
| `[ +0.005, +0.020]` | 123,519 | 0.624 |
| `[ +0.020, +0.100]` | 103,808 | 0.645 |
| `[ +0.100, +0.200]` | 10,953 | 0.545 |
| `[ +0.200, +0.400]` | 1,746 | 0.189 |
...
- Predicted tail mass: 1487.4060
- **Ratio (pred / obs):** **1.121** (<<1 = under-predicting tail; ~1 = calibrated; >1 = over)

### Tail exceedance (deterministic + q975 ensemble support)

| Threshold | n(obs>t) | n(pred>t) | POD | CSI | FAR | q975 soft-POD |
|---|---|---|---|---|---|---|
| +0.050 |     45,659 |     96,907 | 0.470 | 0.177 | 0.779 | 0.940 |
| +0.100 |     12,833 |     15,702 | 0.188 | 0.092 | 0.847 | 0.763 |
| +0.200 |      1,880 |        513 | 0.088 | 0.074 | 0.678 | 0.357 |
| +0.400 |        134 |         14 | 0.090 | 0.088 | 0.143 | 0.127 |

![Q-Q max-of-field](../outputs/diffusion_v36v/qq_max_of_field.png)
![Q-Q mean-of-field](../outputs/diffusion_v36v/qq_mean_of_field.png)

## Figures

- Map comparison: ![](../outputs/diffusion_v36v/map_comparison.png)
- Tile-level summaries: ![](../outputs/diffusion_v36v/tile_metrics.png)
